...
// ResHeaders applies equality check predicate on the "res_headers" field. It's identical to ResHeadersEQ.
func ResHeaders(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldEQ(FieldResHeaders, v))
}

// ResBody applies equality check predicate on the "res_body" field. It's identical to ResBodyEQ.
func ResBody(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldEQ(FieldResBody, v))
}
...
// ResHeadersEQ applies the EQ predicate on the "res_headers" field.
func ResHeadersEQ(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldEQ(FieldResHeaders, v))
}

// ResHeadersNEQ applies the NEQ predicate on the "res_headers" field.
func ResHeadersNEQ(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldNEQ(FieldResHeaders, v))
}

// ResHeadersIn applies the In predicate on the "res_headers" field.
func ResHeadersIn(vs ...string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldIn(FieldResHeaders, vs...))
}

// ResHeadersNotIn applies the NotIn predicate on the "res_headers" field.
func ResHeadersNotIn(vs ...string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldNotIn(FieldResHeaders, vs...))
}

// ResHeadersGT applies the GT predicate on the "res_headers" field.
func ResHeadersGT(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldGT(FieldResHeaders, v))
}

// ResHeadersGTE applies the GTE predicate on the "res_headers" field.
func ResHeadersGTE(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldGTE(FieldResHeaders, v))
}

// ResHeadersLT applies the LT predicate on the "res_headers" field.
func ResHeadersLT(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldLT(FieldResHeaders, v))
}

// ResHeadersLTE applies the LTE predicate on the "res_headers" field.
func ResHeadersLTE(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldLTE(FieldResHeaders, v))
}

// ResHeadersContains applies the Contains predicate on the "res_headers" field.
func ResHeadersContains(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldContains(FieldResHeaders, v))
}

// ResHeadersHasPrefix applies the HasPrefix predicate on the "res_headers" field.
func ResHeadersHasPrefix(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldHasPrefix(FieldResHeaders, v))
}

// ResHeadersHasSuffix applies the HasSuffix predicate on the "res_headers" field.
func ResHeadersHasSuffix(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldHasSuffix(FieldResHeaders, v))
}

// ResHeadersEqualFold applies the EqualFold predicate on the "res_headers" field.
func ResHeadersEqualFold(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldEqualFold(FieldResHeaders, v))
}

// ResHeadersContainsFold applies the ContainsFold predicate on the "res_headers" field.
func ResHeadersContainsFold(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldContainsFold(FieldResHeaders, v))
}

// ResBodyEQ applies the EQ predicate on the "res_body" field.
func ResBodyEQ(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldEQ(FieldResBody, v))
}

// ResBodyNEQ applies the NEQ predicate on the "res_body" field.
func ResBodyNEQ(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldNEQ(FieldResBody, v))
}

// ResBodyIn applies the In predicate on the "res_body" field.
func ResBodyIn(vs ...string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldIn(FieldResBody, vs...))
}

// ResBodyNotIn applies the NotIn predicate on the "res_body" field.
func ResBodyNotIn(vs ...string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldNotIn(FieldResBody, vs...))
}

// ResBodyGT applies the GT predicate on the "res_body" field.
func ResBodyGT(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldGT(FieldResBody, v))
}

// ResBodyGTE applies the GTE predicate on the "res_body" field.
func ResBodyGTE(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldGTE(FieldResBody, v))
}

// ResBodyLT applies the LT predicate on the "res_body" field.
func ResBodyLT(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldLT(FieldResBody, v))
}

// ResBodyLTE applies the LTE predicate on the "res_body" field.
func ResBodyLTE(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldLTE(FieldResBody, v))
}

// ResBodyContains applies the Contains predicate on the "res_body" field.
func ResBodyContains(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldContains(FieldResBody, v))
}

// ResBodyHasPrefix applies the HasPrefix predicate on the "res_body" field.
func ResBodyHasPrefix(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldHasPrefix(FieldResBody, v))
}

// ResBodyHasSuffix applies the HasSuffix predicate on the "res_body" field.
func ResBodyHasSuffix(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldHasSuffix(FieldResBody, v))
}

// ResBodyIsNil applies the IsNil predicate on the "res_body" field.
func ResBodyIsNil() predicate.LogOperation {
	return predicate.LogOperation(sql.FieldIsNull(FieldResBody))
}

// ResBodyNotNil applies the NotNil predicate on the "res_body" field.
func ResBodyNotNil() predicate.LogOperation {
	return predicate.LogOperation(sql.FieldNotNull(FieldResBody))
}

// ResBodyEqualFold applies the EqualFold predicate on the "res_body" field.
func ResBodyEqualFold(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldEqualFold(FieldResBody, v))
}

// ResBodyContainsFold applies the ContainsFold predicate on the "res_body" field.
func ResBodyContainsFold(v string) predicate.LogOperation {
	return predicate.LogOperation(sql.FieldContainsFold(FieldResBody, v))
}
